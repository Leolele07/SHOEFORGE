...
- **原色功能**：颜色选择器新增"原色"选项，可快速恢复到原始材质颜色
- **原料功能**：材质选择器新增"原料"选项，可快速恢复到原始材质类型
- **一键白膜修复**：修复一键白膜功能，确保将所有部件设置为白色
- **恢复原始修复**：修复恢复原始功能，确保恢复到原始材质和颜色，并清除贴图
- **整体优化**：以整体视角修复功能冲突，确保各功能正常工作
